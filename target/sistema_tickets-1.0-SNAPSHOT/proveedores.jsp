                    ...
                    <form class="w-75">
                        <div class="row g-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" id="providerEmail" placeholder="Correo electrónico">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="providerPhone">Teléfono</label>
                                <input type="text" class="form-control" id="providerPhone" placeholder="Teléfono">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="providerAddress" placeholder="Dirección">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="contactPerson">Persona de Contacto</label>
                                <input type="text" class="form-control" id="contactPerson" placeholder="Persona de contacto">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="contactPhone">Teléfono de Contacto</label>
                                <input type="text" class="form-control" id="contactPhone" placeholder="Teléfono de contacto">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="additionalNotes">Notas Adicionales</label>
                                <textarea class="form-control" id="additionalNotes" placeholder="Agregar notas adicionales" rows="3"></textarea>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary mt-3 mb-5">Registrar Proveedor</button>
                    </form>
                </div>
            </div>
        </div>
