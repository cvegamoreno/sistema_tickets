            ...
            <div class="container">
                <div class="text-end">
                    <button type="submit" class="btn btn-primary mt-3" name="action" value="incidentes"
                        onclick="window.location.href='lista-incidentes.jsp'">
                        Lista de Incidentes
                    </button>
                </div>
                ...
                <div class="col-12 d-flex justify-content-center align-items-center text-white">
                    <form class="w-75">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="source">Fuente del caso</label>
                                <select class="form-select" id="source">
                                    <option selected>Seleccione una fuente del caso</option>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="problemDescription" placeholder="Describa el problema"
                                    rows="3"></textarea>
                            </div>
                        ...
                        <button type="submit" style="margin-top: 15px;" class="btn btn-primary mb-4">Enviar Incidente</button>
                    </form>
                </div>
            </div>
        </div>
