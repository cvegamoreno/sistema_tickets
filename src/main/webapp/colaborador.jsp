                        ...
                        <div class="row g-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input list="departamentos" class="form-control" id="departamento" name="departamento"
                                           placeholder="Departamento">
                                    <datalist id="departamentos">
                                        <option value="Departamento de TI">
                                        <option value="Departamento de Comunicación">
                                        ...
                                        <option value="Departamento de Operaciones">
                                    </datalist>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="numeroOficina" name="numeroOficina"
